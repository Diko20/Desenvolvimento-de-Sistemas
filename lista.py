anime = "pokemon"
lista = ["demon slayer", "one piece", "hollow knight", "hunterxhunter"]
notas = [9.5, 10.0, 10.0, 8.0]
...
print(lista) # mostrando a lista nova com o valor adicionado
# -------------------------------------------------------------------
